@{
	...
	'Install-JeaModule.Install'                = 'Installing JEA module {0}' # $moduleObject.Name
	'Install-JeaModule.Installing.Module'      = 'Installing JEA module {0}' # $moduleObject.Name
	
	'New-BootstrapScript.Validation.NoRunFile' = 'Bootstrap folder does not contain a run.ps1 file, which is the start script without which there is no bootstrapping: {0}' # $runFile
